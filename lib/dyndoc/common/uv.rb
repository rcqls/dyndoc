...
$dyn_gem_root=File.expand_path(File.join(__FILE__,"..","..","..","..")) unless $dyn_gem_root

module Uv

  self.syntax_path=File.join($dyn_gem_root,"share","syntax","ultraviolet","syntax")
  self.render_path=File.join($dyn_gem_root,"share","syntax","ultraviolet","render")
